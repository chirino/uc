...
func New(global *cmd.Options) *cobra.Command {
    ...
    command := &cobra.Command{
        Use:   "kamel",
        Short: "finds new releases of kamel",
...
func (o *Options) findGithubReleases() error {
    ...
    return o.GithubUtils.ListGithubReleases("apache", "camel-k", func(release *github.RepositoryRelease) error {
        ...
        for _, a := range release.Assets {
            ...
            filePrefix := "camel-k-client-" + version + "-"
            fileSuffix := ".tar.gz"
            ...
            if request.ExtractTgz == "" {
                request.ExtractTgz = "./kamel|./kamel.exe"
            }
